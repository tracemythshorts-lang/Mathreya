...
import { User, Shield, Heart, Smartphone, Phone, Mail, MapPin, CheckCircle2, ArrowLeft } from 'lucide-react';
        ...
        <div className="px-4 sm:px-6 pb-4 sm:pb-6 relative">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between -mt-10 sm:-mt-12 gap-3 sm:gap-4">
            <div className="flex flex-col sm:flex-row sm:items-end gap-3 sm:gap-4">
              <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl sm:rounded-3xl bg-gradient-to-tr from-[#8B3012] to-[#C85A32] border-4 border-white shadow-md flex items-center justify-center font-serif text-2xl sm:text-3xl font-bold text-white shrink-0 overflow-hidden">
                {user.avatarUrl ? (
